...
From the SCC curve above, we can notice that the unobserved fragment length is estimated at the max. of the curve at `r fl` and the read length of the experiment is at `r rl`
